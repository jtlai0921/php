...
<div id="main">
	...
	<table class="list">
		...
		<?php 
		$query="select ssm.id,ssm.module_name,sfm.module_name father_module_name,ssm.member_id from sfk_son_module ssm,sfk_father_module sfm where ssm.father_module_id=sfm.id order by sfm.id";
