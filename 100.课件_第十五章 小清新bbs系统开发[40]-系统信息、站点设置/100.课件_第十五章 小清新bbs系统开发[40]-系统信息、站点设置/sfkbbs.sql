...
(9, 2, 'hahah1111111', 'hahah', '2015-01-16 19:05:45', 1, 620),
(15, 5, '哈哈哈<span>11111111', '<span>dwqdqwdwqdwq</span>\r\ndqwdwqdwq\r\ndwqdwqdwq1\r\ndqwdwq1', '2015-01-22 11:29:27', 1, 4),
(14, 6, '这贴子是我私房库发的！', '这贴子是我私房库发的！', '2015-01-22 10:58:37', 7, 3);
...
CREATE TABLE IF NOT EXISTS `sfk_father_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='父版块信息表' AUTO_INCREMENT=28 ;
...
(1, 'sfkbbs', '私房库,私房库111', '私房库私房库私房库私房库私房库私房库私房库私房库私房库私房库私房库私房库私房库11');
...
(4, '孙胜利', '96e79218965eb72c92a549dd5a330112', '2015-01-26 18:26:54', 1);
